...
<div class="flex justify-center items-center min-h-screen bg-gray-100 p-6">
    <div class="w-full max-w-2xl bg-white shadow-md rounded-lg p-8">
        <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Modifier le Produit</h1>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label class="block text-gray-700 font-semibold mb-2">Changer l'image</label>
                <input type="file" name="image"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
